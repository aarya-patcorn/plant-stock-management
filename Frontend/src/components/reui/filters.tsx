...
function SelectOptionsPopover<T = unknown>({
  ...
  const renderMenuContent = () => (
    <>
      {field.searchable !== false && (
        <>
          <Input
            ...
            className={cn(
              "h-8 rounded-md border border-slate-200 bg-white px-2 text-sm text-slate-900 shadow-none",
      ...
      <div className="relative isolate flex max-h-full overflow-hidden rounded-lg bg-white">
        <div
                        ...
                        if (hasSubMenu) {
                          ...
                          return (
                            ...
                            >
                              ...
                              <DropdownMenuSubContent className="isolate w-[200px] rounded-lg border border-slate-200 bg-white shadow-xl ring-1 ring-black/5">
